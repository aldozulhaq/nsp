                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ml-[5px] flex-none" src="/assets/images/icon_box.png" alt="logo" />
                            <span><img className="w-12 ml-[5px] flex-none" src="/assets/images/icon_br.png" alt="logo" /></span>
                        </NavLink>
